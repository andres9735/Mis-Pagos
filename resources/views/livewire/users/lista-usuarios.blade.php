        ...
        <tbody class="text-gray-700 text-sm font-light">
            ...
            <tr wire:key="{{$user->id}}" class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left">
                    <a wire:navigate href="{{route('users-users-edit',$user->id)}}">Editar</a>
                    <button wire:click="delete({{$user->id}})" wire:confirm="Desea borrar este registro?" wire:navigate>Eliminar</button>
                </td>
            </tr>
            @empty
